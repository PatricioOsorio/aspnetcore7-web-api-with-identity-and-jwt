...
namespace ApiNet7WithJwtAndIdentity.Migrations
{
    ...
    [Migration("20231115013200_CorreccionRelacionesArrastres")]
    partial class CorreccionRelacionesArrastres
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApiNet7WithJwtAndIdentity.Models.TipoGruas", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdTipoGrua"));
            ...
            modelBuilder.Entity("ApiNet7WithJwtAndIdentity.Models.Ubicaciones", b =>
                {
                    ...
                    b.Property<int?>("SiniestrosIdSiniestro")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SiniestrosIdSiniestro");
            ...
            modelBuilder.Entity("ApiNet7WithJwtAndIdentity.Models.Gruas", b =>
                {
                    ...
                    b.HasOne("ApiNet7WithJwtAndIdentity.Models.TipoGruas", "TipoGrua")
                        .WithMany("Gruas")
                        .HasForeignKey("IdTipoGrua")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Corralon");

                    b.Navigation("TipoGrua");
                });
            ...
            modelBuilder.Entity("ApiNet7WithJwtAndIdentity.Models.Ubicaciones", b =>
                {
                    ...
                    b.HasOne("ApiNet7WithJwtAndIdentity.Models.Siniestros", null)
                        .WithMany("Ubicaciones")
                        .HasForeignKey("SiniestrosIdSiniestro");
                });
